...
namespace App\GraphQL\Query\Apartment;
...
class ApartmentFind extends FieldHelperAbstract
{
    /**
    ...
    */
    ...
    /**
    * Name of field in Main Query type. If not set will be used class name in snake_letters style
    *
    * @return bool|null|string
    */
    public function getName()
    {
        return 'ApartmentFind';
    }
    ...
    */
    ...
    {
        return "Model that find Apartment objects ";
    }
}
